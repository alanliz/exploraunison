...
"Queremos que el talento no conozca barreras de género. Históricamente, las mujeres han estado subrepresentadas en estas áreas, y estamos comprometidos a cambiar esa realidad", afirmó la Ing. Sofía Robles, exalumna y representante del consorcio empresarial durante la ceremonia de lanzamiento. "Esta beca no solo cubre la matrícula; incluye apoyo para material de estudio, cursos de inglés y liderazgo, y acceso a una red de mentoras que las guiarán en su desarrollo profesional". Las aspirantes podrán aplicar a partir de la próxima convocatoria de admisión, y se espera que el programa duplique su alcance en los próximos tres años.`
  },
  {
    id: 4,
...
"Cada pieza, cada soldadura, cada cálculo, ha sido hecho por nosotros. Es la aplicación práctica de todo lo que aprendemos en las aulas", comenta la capitana del equipo, Mariana Durán. "Este año nos hemos enfocado en la durabilidad y la ligereza. La meta no es solo pasar las pruebas de resistencia y velocidad, sino competir por un lugar en el podio". La competencia se celebrará el próximo mes en Tennessee, Estados Unidos, y el equipo 'Baja Unison' es uno de los cinco representantes de México.`
  },
];
